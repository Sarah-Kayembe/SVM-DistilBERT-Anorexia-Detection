...
# Tokenize text data with a maximum sequence length
X_train_tokens = tokenizer(X_train.tolist(), padding=True, truncation=True, return_tensors='pt', max_length=128).to(device)
X_val_tokens = tokenizer(X_val.tolist(), padding=True, truncation=True, return_tensors='pt', max_length=128).to(device)
